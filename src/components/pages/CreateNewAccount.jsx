                ...
                >
                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit} sx={{ width: "100%" }} className="clickable">
                        ...
                        <Grid container sx={{ marginTop: "30px", width: "80%", marginLeft: "10%" }}>
                            <Grid item sx={12} md={12} lg={12}>
                                <div style={{ display: "flex", alignItems: "center", cursor: "pointer", marginTop: "-18px",marginLeft:"-40px" }} className="clickable">
                                    <CustomColorCheckbox icon={<RadioButtonUncheckedIcon style={{ height: "15px", width: "15px", marginLeft: "-9px" }} />} checkedIcon={<RadioButtonCheckedIcon style={{ height: "15px", width: "15px", marginLeft: "-9px" }} />} label="Beni Hatırla" />
                    ...
                    <div className="signin-footer">
                        <div className="signin-footer-text">
                            ...
                            <h5 className="signup-bottom-heading2 clickable" 
